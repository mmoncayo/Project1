$(document).ready(function () {
    ...
    // function that calls the GitHub Jobs API for pulling data based on the job search keywords that were inputted (both job search terms and city search term)
        ...
        $.ajax({
            ...
            .then(function (jobResults) {
                ...
                for (var i = 0; i < jobResults.length; i++) {
                    ...
                    $("#jobCity").append(jobDiv, jobTitleDiv, jobLocationDiv);
    ...
    function runQuery(newLink) {
        ...
        $.ajax({
            ...
            .then(function (WeatherData) {
                ...
                $("#articleCard").append("<h5><p>But it feels like: " + ((WeatherData.list[1].main.feels_like - 273.15) * 9 / 5 + 32).toFixed(1) + "°F" + " </p></h5>");
    ...
    $("#search").on("click", function (event) {
        ...
        var jobQueryURL = "https://cors-anywhere.herokuapp.com/https://jobs.github.com/positions.json?description=" + jobTerm + "&location=" + queryTerm;
